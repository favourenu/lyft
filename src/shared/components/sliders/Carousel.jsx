  ...
  const testimony = [
    {
      id: uuid(),
      name: "Harold",
      quote: "As a student, it’s hard to complete my class work around a schedule. I started driving more with Lyft and realized it was the perfect opportunity to make money and work on my own time! Driving with Lyft gives me freedom in my schedule to focus on school, which is my main priority.",
      ...
      extra: "Driving with Lyft since 2020"
    },
    {
      id: uuid(),
      name: "Christine",
      ...
      extra: "Driving with lyft since 2016"
    },
    {
      id: uuid(),
      name: "Timothy",
      quote: "Driving with Lyft is the perfect way to make money and be there for my family’s needs. I love providing a way to get my passengers from point A to B. Independence is key for me, and I enjoy meeting new people while driving!",
      ...
      extra: "Driving with lyft since 2017"
    },
    {
      id: uuid(),
      name: "Mary",
      ...
      extra: "Driving with lyft since 2019"
    }
  ]
    ...
    <div className="carousel-container">
      <Slider {...sliderSettings} className="carousel-slider">
        {testimony.map((tmn,idx)=>(
          ...
          <p className='qoute'><q>{tmn.quote}</q></p>
